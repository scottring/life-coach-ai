...
// Check if Firebase credentials are configured (support both VITE_ and REACT_APP_ prefixes)
const hasFirebaseCredentials = 
  (process.env.REACT_APP_FIREBASE_API_KEY && process.env.REACT_APP_FIREBASE_API_KEY !== 'your-firebase-api-key') ||
  (process.env.VITE_FIREBASE_API_KEY && process.env.VITE_FIREBASE_API_KEY !== 'your-firebase-api-key');
