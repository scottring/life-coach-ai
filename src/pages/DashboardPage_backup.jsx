...
import { PaperAirplaneIcon, ChevronDownIcon, ChevronRightIcon, PlusCircleIcon, FolderIcon, ArrowUturnLeftIcon, XMarkIcon, EyeIcon, EyeSlashIcon } from '@heroicons/react/24/outline';
...
// Task Item Component
function TaskItem({ task, onToggleComplete, isSelectable, isSelected, onSelect, categoryKey, onTaskClick }) {
  ...
  return (
    <div
      className={`ml-8 flex items-start space-x-3 rounded-lg p-3 ${
        isOverdue
